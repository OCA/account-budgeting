...
**Analytic Tag Dimension Enhancements (WIP)**

When 1 dimension (analytic account) is not enough, we can use analytic_tag_dimension
to create persistent dimension columns.
Note that, there is another PR that intend to enhance it further,
https://github.com/OCA/account-analytic/pull/251
